...
class ComplainPolicy
{
    ...
    {
        return $user->can('view_any_complain');
    }
    ...
    {
        return $user->can('create_complain');
    }
    ...
    {
        return $user->can('update_complain');
    }
    ...
    {
        return $user->can('delete_complain');
    }
    ...
    {
        return $user->can('delete_any_complain');
    }
